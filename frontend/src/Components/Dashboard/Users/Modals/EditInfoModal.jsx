...
const EditInfoModal = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await putData('/backend/user/UpdateUser', data);
            ...
            Swal.fire({
                ...
                props.setShowEditInfoModal(false); // mbyll modalin pasi useri e klikoi OK
              });
    ...
    return(
        <div data-testid="edit-info-modal"  className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-gray-900 bg-opacity-50">
